...
func NewSecChanService(app z.AppServerInterface, eps []z.EndpointInterface, cfg server.ConfigInterface) ServiceInterface {
	...
	app.Middleware().Insert(z.SessionMwKey, z.InsertAfter, SecChanMwKey, sec_mw.ServerReqHandler, sec_mw.ServerResHandler)
	return svc
}
...
func NewSecChanClient(ep z.EndpointInterface, cfg ClientConfigInterface) (cc ClientInterface, jb job.JobInterface) {
	...
	cc.Middleware().Insert(z.SessionMwKey, z.InsertAfter, SecChanMwKey, sec_mw.ClientReqHandler, sec_mw.ClientResHandler)
	return
}
